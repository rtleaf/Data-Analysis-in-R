...
`r paste0(syl.comp$VAR2[which(syl.comp$VAR1 == "Covid 1")])`

`r paste0(syl.comp$VAR2[which(syl.comp$VAR1 == "Covid 2")])`

`r paste0(syl.comp$VAR2[which(syl.comp$VAR1 == "Covid 3")])`

`r paste0(syl.comp$VAR2[which(syl.comp$VAR1 == "Covid 4")])`

`r paste0(syl.comp$VAR2[which(syl.comp$VAR1 == "Covid 5")])`
